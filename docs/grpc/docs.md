...
When using both context and target, the score behaves a little different, where the integer part of the score represents the &#34;rank&#34; with respect to the context, while the decimal part of the score relates to the distance to the target. |
